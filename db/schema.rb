...
ActiveRecord::Schema[7.0].define(version: 2023_06_01_222310) do
  ...
  create_table "roundups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["transaction_id"], name: "index_roundups_on_transaction_id"
  end
  ...
  add_foreign_key "roundups", "transactions"
